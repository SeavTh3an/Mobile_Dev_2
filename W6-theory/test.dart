...
class ColorTapsScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    ColorTapsNotifier ColorNotifier = context.watch<ColorTapsNotifier>();
    return Scaffold(
      appBar: AppBar(title: Text('Color Taps')),
      body: ListenableBuilder(
        listenable: globalNotifier,
        builder: (context, child) => Column(
          children: [
            ColorTap(
              type: ColorType.red,
              tapCount: ColorNotifier.redTapCount,
              onTap: () => ColorNotifier.increment(ColorType.red),
            ),
            ColorTap(
              type: ColorType.blue,
              tapCount: ColorNotifier.blueTapCount,
              onTap: () => ColorNotifier.increment(ColorType.blue),
            ),
          ],
        ),
      ),
